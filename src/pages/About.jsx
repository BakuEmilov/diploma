  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">
        Welcome to Nike Shop, your ultimate destination for trendy and high-quality sportswear. We
        are passionate about providing athletes and sports enthusiasts with top-notch products to
        enhance their performance and style.
      </p>
      ...
      <p className="about-us-values">
        ...
        comfort, and style. Your satisfaction is our top priority, and we strive to provide
        exceptional customer service and a seamless shopping experience.
      </p>
      <p className="about-us-visit">Visit us today and unleash your potential with Nike Shop!</p>
    </div>
  );
};
